...
const SITE_ORDER = ['劉備', '曹操', '孫權', '呂布', '諸葛亮', '郭嘉', '馬超', '周瑜', '陳宮', '張角', '典韋', '左慈', '于吉', '貂蟬', '孫堅', '趙雲', '張飛', '關羽', '小喬', '法正', '黃月英', '徐晃', '高順', '魏延', '徐庶', '魯肅', '呂玲綺', '關銀屏', '樂進', '關興', '張星彩', '張梁', '張苞', '孟獲', '張燕', '黃蓋', '荀攸', '廖化', '程普', '甘寧', '張寶', '程昱', '吳國太', '荀彧', '步練師', '曹丕', '糜竺', '王平', '公孫瓚', '司馬懿', '龐統'];
